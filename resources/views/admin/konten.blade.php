                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    ...
                    <ul class="menu-inner py-1">
                        ...
                        <li class="menu-item active">
                            <a href="{{ route('konten.index') }}" class="menu-link">
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel1">Form Tambah Konten</h5>
                                            <button
                                                type="button"
                                                class="btn-close"
                                        ...
                                        <form action="{{ route('konten.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" name="tanggal" value="{{ now()->format('YmdHis') }}">
                                                <div class="row">
                                                    <div class="col mb-3">
                            ...
                            <!-- Layout Demo -->
                            <div class="card">
                                <h5 class="card-header">Table Konten</h5>
                                <div class="table-responsive text-nowrap">
                                    <table class="table">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            @foreach ($kontens as $aa)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ Str::words($aa->judul,8) }}</td>
                                                <td>{{ Str::words($aa->keterangan,8) }}</td>
                                                <td>{{ $aa->kategori }}</td>
                                                <td><img style="max-width:100px" src="storage/konten_foto/{{ $aa->foto }}" /></td>
                                                <td>
                                                    <a href="">
